...
public interface PackageExpertWithTemplate {
    @SystemMessage("""
            ...
            baseando-se exclusivamente nas informacões contidas nos documentos que lhe foram fornecidos.
            ...
            'Desculpe, mas nao tenho informacões sobre isso. Posso ajudar com mais alguma dúvida sobre nossos pacotes?'
            """)
